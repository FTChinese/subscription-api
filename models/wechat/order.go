...
// a native app.
func (c Client) BuildAppOrder(u UnifiedOrderResp, subs paywall.Order) AppOrder {
	p := AppOrderParams{
...
func (c Client) BuildInAppBrowserOrder(u UnifiedOrderResp, subs paywall.Order) InAppBrowserOrder {
...
func BuildMobileOrder(resp UnifiedOrderResp, subs paywall.Order) BrowserOrder {
	return BrowserOrder{
		Order:   subs,
