...
type ProrationSource struct {
	...
	CreatedUTC  chrono.Time `db:"created_utc"`  // The moment this record is created.
	ConsumedUTC chrono.Time `db:"consumed_utc"` // The moment the upgrading order is confirmed.
