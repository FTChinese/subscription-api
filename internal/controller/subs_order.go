...
// PaymentResult gets payment result from providers
// This does not modify data on our side.
func (router SubsRouter) PaymentResult(w http.ResponseWriter, req *http.Request) {
	defer router.Logger.Sync()
	sugar := router.Logger.Sugar()
